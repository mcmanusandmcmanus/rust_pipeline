...
- Filter both APD and LAFD to **calendar year 2024** before any heavy lifting; both slices sit below ~500k rows, so enforce a **500k per-dataset cap** unless future refreshes exceed that volume.
